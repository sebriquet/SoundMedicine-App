...
class FifthRecording: UIViewController, AVAudioRecorderDelegate, MFMailComposeViewControllerDelegate,UITextFieldDelegate {
 ...
 var audioRecorder: AVAudioRecorder!
    ...
    var isRecording = false
        ...
        //MARK: AUDIO HANDLING
               ...
               audioFilename = paths [0] .appendingPathComponent("AboveRightScapula\(fileNumber).wav")
         ...
         // MARK: ACCELEROMETER HANDLING
           ...
           func setupTwoChanneledWave() {
             ...
             ///  let accFilename = paths[0].appendingPathComponent("AboveRightScapula\(fileNumber).wav")
