...
class SixthRecording: UIViewController, AVAudioRecorderDelegate, MFMailComposeViewControllerDelegate,UITextFieldDelegate {
    ...
    var isRecording = false
           ...
           func setupRecorder() {
            ...
            //MARK: AUDIO HANDLING
               ...
               audioFilename = paths [0] .appendingPathComponent("BelowRightScapula\(fileNumber).wav")
           ...
           func setupTwoChanneledWave() {
            ...
            /// let accFilename = paths[0].appendingPathComponent("BelowRightScapula\(fileNumber).wav")
