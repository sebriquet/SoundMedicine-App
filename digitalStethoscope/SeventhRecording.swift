...
class SeventhRecording: UIViewController, AVAudioRecorderDelegate, MFMailComposeViewControllerDelegate,UITextFieldDelegate {
 ...
 var audioRecorder: AVAudioRecorder!
    ...
    var isRecording = false
           ...
           override func viewDidLoad() {
               super.viewDidLoad()
               recorButton.layer.cornerRadius = 5
           ...
           func setupRecorder() {
            ...
            //MARK: AUDIO HANDLING
               ...
               audioFilename = paths [0] .appendingPathComponent("AboveLeftScapula\(fileNumber).wav")
    ...
    //MARK: ACCELEROMETER HANDLING
           ...
           func setupTwoChanneledWave() {
              ...
              /// let accFilename = paths[0].appendingPathComponent("AboveLeftScapula\(fileNumber).wav")
    ...
    //MARK: RECORD BUTTON ACTIONS
           ...
           @objc func endRecoding(timer: Timer) {
               ...
               audioRecorder?.stop()
               isRecording = false
               statusLabel.text = "FINISED RECORDING"
               self.motion.stopAccelerometerUpdates()
               buttonTimer.invalidate()
               print(accdata.count)
               setupTwoChanneledWave()
            recorButton.isEnabled = false
